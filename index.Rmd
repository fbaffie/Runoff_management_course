...
Email: fkba (at) hvl (dot) no

Office: Stadionbygget 03-11a
...
- Master project idea?
- Post-master plans?
- What do you want to learn / do in this course?
...
- Assess how climate change affects water balance and water quality in catchments
- Apply relevant methods for hydrologic analysis of catchments
- Understand how relevant computer software and GIS can be used to identify flood-prone areas and potential problems arising from urban flooding and runoff
- Knowledge of erosion, sediment transport and flood mitigation along river courses
- Be aware of land use planning issues related to rural and urban flood management
- Understand the challenges and possibilities related to local runoff management and provide input for resilient solutions.
...
- Make simple hydrological, hydrogeological  and hydraulic calculations relevant to run-off management
- Use different measuring techniques and carry out simple dimensional calculations of rainwater harvesting and tree management systems (so called blue-green structures) for urban runoff management
- Develop concrete plans for local runoff management


## General competence
<img src="images/logo.png" class="cover">

- Assess the individual contributions to catchment hydrology from rain, snow and glacier melt and their respective timescales
- Understand changes in catchment hydrology due to climate change and make urban areas less vulnerable to extreme events.
- Critically evaluate their own and others’ plans, projects and reports, and communicate with specialists and the general public about issues related to urban and rural flooding
...
- Room for freedom with group projects
...
<!-- Svingen F2 also available for exercises -->
...
Tue. 08 May | 09:15-12:00	| Green SW infrastructure | Svingen F1
Tue. 08 May | 13:15-16:00	| [Hydrological modelling](01_Hydrology/4_hydrological_modelling.html) | Svingen F2
...
<!-- Wed. 16 May | 09:15-12:00	| Soils, erosion and deposition	| Svingen F2 -->
...
Thu. 24 May | 09:15-12:00	| [Exercises: water harvesting](EXERCISES/EX04.html) | Svingen F2


<!-- Fossbygget-F208  Kjelda also available for exercises -->

## Agenda: 28 May - 4 June
<img src="images/logo.png" class="cover">   

Day	| Time	| Topic	| Room
--- | --- | --- | --- 
Wed. 30 May | 09:15-12:00	| [Soils, erosion and deposition](02_Hydraulics/3_erosion_deposition.html)	| Svingen F2
Wed. 30 May | 13:15-16:00	| [Flood vulnerability](03_Catchment_scale/1_flood_mapping.html) | Svingen F2
Thu. 31 May | 09:15-12:00	| Excursion	| Leikanger
Fri. 1 Jun  | 09:15-12:00	| Debrief: excursion and course | Svingen F2
Fri. 1 Jun  | 13:15-16:00	| Projects discussions | Svingen F2
Mon. 04 Jun | All day	| Excursion	| Utvik
...
Tue. 12 Jun | 08:00-16:00 | Group presentations | Stadionbygg Auditorium
Thu. 14 Jun | 08:00-17:00 | Individual exam | SOG-Møterom 3.etg Stadionbygg

## Group presentations in Stadionbygget Auditorium: Tue. 12 June
<img src="images/logo.png" class="cover">

Time	| Group	| Project
--- | --- | ---
09:00 | Anna Astrid Famke | Discharge gauging
09:20 | Nils Anne Dag Peter | Small-scale vulnerabitilies
09:40 | John Sushmitha Willemijn | Vegvesen repair practices
10:20 | Erik Tonje Eirin | Sogndal's catchment
10:40 | Helge Kristine Vibeke | Planning Lyseparken |
11:00 | Adam Erling Torbjørn | Flood routing
11:20 | Ragnar Sarina Theo | Green infrastructure synthesis

## Time blocks and quizzes
<img src="images/logo.png" class="cover">
...
We look at different components of the water cycle. Climate change will impact various components of the hydrological cycle. We will quickly review potential evolutions and base our first quizz on this theme.

Quiz theme for Monday 07 May: 

[Effects of land hydrology on atmospheric processes and climate change](https://www.youtube.com/watch?v=zMjchti6LdM)
...
We will first discuss surface hydrological processes: precipitation, snow hydrology and vegetation processes: 
[Lecture](01_Hydrology/2_hydrological_processes_1.html)

We will then cover subsurface processes (groundwater, soil water and runoff generation), which are important for the design of green stormwater infrastructure. 
[Lecture](01_Hydrology/2_hydrological_processes_2.html)
...
Quantifying floods and droughts helps design better protection / adaptation measures.

Please attend Simen's Master project presentation on flood frequency analysis: Wednesday 09 May, 14:30.

Quiz theme for Monday 14 May:
...
Quiz theme for tuesday May 22:

NVE report: [Identification of areas exposed to flooding in Norway at a national level](https://gis3.nve.no/metadata/rapporter/SmallScaleFloodAssesment_v3.pdf)
...
How much flow can an open channel convey? 

How high will the water level be for a specifc discharge rate and slope?
...
Water can mobilize particules of various sizes. This has to be taken into account in the design of hydraulic structures.

In extreme cases, boulders can be taken with the flow and form devastating debris flows. On the other hand, the smallest suspended particules are those that carry most pollution in SW runoff
...
Those results are used to produce flood zoning maps. 

In the last quiz, we looked at how [flood susceptibility maps](https://temakart.nve.no/link/?link=flomaktsomhet) had been computed based on the explaination document: [identification of areas exposed to flooding in Norway at a national level](https://gis3.nve.no/metadata/rapporter/SmallScaleFloodAssesment_v3.pdf). A more polished report on this methodology, including a wider perspective, can be found [there](http://publikasjoner.nve.no/report/2011/report2011_07.pdf).

Based on group work prepared by NVE, we will work on holistic catchment analysis and discuss specific cases of vulnerability to flooding: [lecture](03_Catchment_scale/1_flood_mapping.html)
...
Based on flood zoning maps and the quantification of hydrological extremes in specifc catchments, protection measures can be designed. Those consist of riverbank engineering features such as dikes, diverting channels. 

Based on last year's excursion, we will look at a simple design during an exercise session

This session will consist of a full-day excursion with Svein Vågane from NVE Førde.
...
Even Loe from Statkraft Gaupne will take us to Jostedal to present us the hydropower infrastructure in the valley.

We will see that the hydro-electrical scheme was originally developed to mitigate flooding and discuss Statkraft's responsability in this regard.

We will also visit field equipment such as meteorological and gauging stations that help optimize both production and flood protection.

## Land use 
<img src="images/logo.png" class="cover">
[Lecture (extra, not covered in class)](03_Catchment_scale/4_land_use.html)
...
<img src="images/logo.png" class="cover">
[Lecture (extra, not covered in class)](04_Urban_SW/3_design.html)
...
Some examples focus on SW infrastructures but not all, in an effort to distinguish important design principles and constraints. This includes legibility. practicality, multi-functionnality...
...
## Hydrological processes exercises
<img src="images/logo.png" class="cover">

- Program a temperature-index model for snowmelt (provided by [Uni Zürich](http://www.geo.uzh.ch/en/units/h2k/Services/HBV-Model/Exercise-6.html))
- Designing drinking water infrastructure: flow through sand filters 
- Steady flow in an unconfined aquifer

## Hydrological modelling exercises
<img src="images/logo.png" class="cover">

The goal is to complete exercises 1 and 3 suggested by Jan Seibert with the hydrological model [HBV Light](https://www.geo.uzh.ch/en/units/h2k/Services/HBV-Model.html).
The program is on Fronter, you need to download the data. You can try to install the software on your laptop but there was a resolution problem on mine.
Otherwise, the program is installed with the data on the 8  most front computers of room: F-208 Kjelda.
Please read the [introduction lecture and manual](https://www.geo.uzh.ch/en/units/h2k/Services/HBV-Model/HBV-Download.html) and try those exercises:

- Calibration exercise: follow those [instructions](https://www.geo.uzh.ch/en/units/h2k/Services/HBV-Model/Exercise-1.html)
- Estimation of design flood: follow those [instructions](https://www.geo.uzh.ch/en/units/h2k/Services/HBV-Model/Exercise-3.html)

Put your files on a USB stick or send them to me as a .zip. Two groups will (informally) present their results on May 14. 

## Hydropower and hydraulics exercises
<img src="images/logo.png" class="cover">

- Case study of Statkraft's hydropower infrastructure in Jostedal
- Designing flood protection measures in Lærdal

## Urban hydrology and green infrastructure exercises
<img src="images/logo.png" class="cover">

Some calculations and drawings based on a water harvesting example in Tucson, Arizona:
[Exercise without answers](EXERCISES/EX04.html)

<!-- [Preparation work](04_Urban_SW/2_green_infra_quiz.html) -->



## Urban and rural hydrology exercises: field observations and planning
<img src="images/logo.png" class="cover">

- Visit of a site where 100 new dwellings had been suggested (Leikanger). 
...
- Send questions and answers to quizzes: I could easily have given the final grades only based on this work last year!
- Complete the minimum requirements of exercise sessions
- I don't care if you miss an excursion but they will be quite fun!

Note: I do not give grades, I only advise the censor based on the exam and the general completion of the work requirements.
...
2. Individual in-depth oral discussion on the project work, the "second" project and finally some aspects of the course material (focus on take home messages. Remembering the most difficult equations will not be required, but they should be qualitatively understood and you should have an idea on how to apply them).
Grading A-F.
...
[USDA National Engineering Handbook - Hydrology](https://www.nrcs.usda.gov/wps/portal/nrcs/detailfull/national/water/manage/hydrology/?cid=stelprdb1043063)
...
Other credits go to Wikipedia, Google maps, Norwegian maps (https://kart.finn.no/, https://norgeskart.no), Swiss Topo (https://map.geo.admin.ch), Sebastian Mermild and previous colleagues for some pictures, Jan Seibert (Uni Zürich) for HBV Light.
