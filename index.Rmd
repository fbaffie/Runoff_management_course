...
Main project	| People	| Second project
--- | --- | --- 
Design | Tew. Ragn. Bjø. Rann. | Social
Social | Håk. Chr. Cal. | Flåm
Flåm | Ann. Mar. Mat. | Lab
Lab | Jan. Oli. Sim. | Voss
Voss | Tro. Jos. Vic. Gur. | Design 
...
- Slide show of 5 minutes per person (so 15 or 20 min depending on the group)
- The group with the same "second project" gets priority for questions
- Student need to prepare what they like/agree or don't in each project
- Then the individual exam will discuss the personal project, the second project and the course material
