...
> - Potential evapotranspiration only depends on energy input. It is the ET without moisture limitation (most soils will be moisture-limited)
...
- Evapotranspiration (ET): sum of all vaporization processes in a catchment (open water, soils, transpiration from plants). Can be estimated by closing the hydrological cycle, mass-transfert or energy-balance methods.
- Potential ET is the maximum achievable ET with unlimited soil moisture supply
