...
> - More, and more accurate, monitoring data on long-term timeframes as floods are rare events and much data is needed to explain causal realtionships between CBFM/NFM and downstream effects. 
> - Need more investigations on the scale dependencies of a model. Are models of small catchment areas valid on larger ones?
> - Need better coordination and collaboration of local and national flood risk management initiatives to fully understand the change in risk after mitigation. Which initiative gave most/ least effect?

## Kristine
> - More systematic long-term data on the impacts on CBFM/NFM compared to traditional engineering solutions.
> - Toolbox with practical advice and updated research results for practitioners.
> - Improved communication between all involved stakeholders.
...
The magnitude of a fluvial flood depends on where you are in the catchment. The first step in a flood process is the inflow of water from hillslopes to a river. Next it is the merging of several rivers into one, and last, the merging of different cathments. 

## Vibeke
> - Therefore- to understand the impact of a CFBM/NFM intervention it is crucial to take into account where in this system the intervention is done. 
...
> - **Catchment-Based Flood Management(CBFM) and Natural Flood Management (NFM) differs from traditional flood management techniques, how so?**
> - Traditional flood management techniques focuses solely on flood mitigation, while CBFM/NFM incorporates potentially significant co-benefits such as enhanced eco-system services, greater biodiversity, improved soil and water quality, carbon sequestration, reduced soil erosion, greater agricultural productivity and improved health and well-being.

## Dag Petter
> - **The performance, longevity and operation and maintenance of CBFM/NFM can be difficult to assess due to uncertainties associated with the approach. This was discussed in the paper, (1) how do they recommend a CBFM/NFM system to be assessed, (2) why should they be monitored, and (3) are there anything to be cautious about?**
> - (1)Due to the complexity which is associated with co-benefits, they recommend to compare it to traditional engineering solutions. (2) This can uncover the degree of impact any specific setup in a catchment has. With proper monitoring, cause and effect of processes which are attempted can be lifted from a hypothetical concept to empirical knowledge.  (3) All catchments are different, thus comparisons are not necessarily accurately depicting either catchment.


## Helge

> - **Are there any trends in the flood patterns in the UK?**
> - The UK has a long an dense precipitation dataset. The data show no change in average yearly precipitation, but it shows that there is a statisticial increase in winter precipitation, and a decrease in summer precipitation. The river with the longest flood gauge monitoring dataset (river Thames) show an increase in flood events, but no increase in flood magnitude. As measurement techniques has changed over the years, and many catchments have had flood managements interventions, it is difficult to find representative baseline data for most areas. 

## Helge
> - Analyzing sediment deposits it seems like there have been flood-rich periods (on decade-scales) followed by flood-poor periods. A limit with these analysis is that the sediment outpoor from the rivers could be affected by human interventions in the catchement area.
Climate projections does not show any clear trend in annual precipitation patterns in the UK, but there could be local and temporal variations (enforcing the trends allready seen with more precipitation in winter).

## Helge
> - **By changing land-use, is it possible to affect flood magnitudes?**
> - Yes, for moderate rainfall events, but maybe not extreme events. This statement seems to be more valid for small/medium catchments and less for larger ones. Suggested actions:
> - Increase forest-cover
> - Secure appropriate forestry management - avoid clear-felling.
> - Maximize urban retention capacity to reduce flood magnitude.
> - Minimize soil compaction due to livestoock or machinery

## John Sverre
> - **Name two examples on how we can manage infiltration and overland flow in urban land-use.**
> - Increase permeable areas and surface storage.

> - **What do projections on climate change show for annual rainfall totals in the UK**
> - No systematic change (between a 16% reduction and a 14% increase, according to 80% of the simulations). However, there has been statistically significant changes in seasonal variation (increase in winter, decrease in summer).

## Torbjørn

> - **What does the term "Natural Flood Management" refer to? **
> - It as collective term for methods of flood management that seeks to restore or enhance catchment processes that have been affected by humans in one way or the other. These methods are characterized by having significant co-benefits such as improving or restoring ecosystem services. 

>- **What is the most important, and in some studies the only, land cover factor that has an effect on mean annual floods?  **
> - The extent of urban land cover

## Torbjørn
> - **Why should there be beavers in every stream?**
> - Beavers rock. They build dams. Dams reduces the velocity and discharge in a stream.

## Famke

> - **Which monitored catchment measures are important for flood mitigation?**
> - Small and large catchment measures give a better understanding of the benefits of CBFM and NFM. The small catchments are used to simulate the changes of land use and management in larger catchments, whereas larger catchments establish scale and spartial location of different types of catchment based intervention that has an effect on flooding.

## Famke

> - **What are the effects of forest on flooding?**
> - Forests are in general expected to store more water in the soil, especially during summer, because of their greater usage of water compared to grasland. Forests produce higher evaporative losses, because of their storage of water in trees.
If the flood is caused by storms (rarly happening) forests fuction as windblocker, so the flood is not huge.
But if the flood is caused by other reasons there is almost no difference between forest and grasland.

## Erik

> - **How can livestock farming influence flooding?**
> - Livestock farming (in particular: high density) can lead to soil compaction, which in turn decreases infiltration capacity. According to a model study, this practice gave a 7 % increase in flood peak after a storm. In another study, a plot-scale experiment, grazed (by sheep) plots were compared to tree-planted plots and found to produce 48%-78% more run-off. After five years, infiltration rates were 67 times higher.

## Erik

> - **What other natural processes must one be mindful of when implementing interventions intended to reduce flooding (fluvial)?**
> - "Sedimentary, geomorphological and ecological processes in the river, as well as direct hydrological effects".