...
- Main water storages and key hydrological processes between them
...
There is great hydrology glossary online:
...
<img src="images/culvert_catchment.png"  height="530" width="auto">

## Exception: karstic aquifers
<img src="images/map_dabube.png" height="530" width="auto">
...
<img src="images/LA_water_map.png" height="530" width="auto">
...
> - **0mm for glacier melt: do you think it is a big approximation?**
> - I don't think it's too big: only 1% of glacier covered areas. their mass balance is probably less negative than in Switzerland.

## Water budget at the catchment scale

The variation in volume of water stored in a catchment can be written as:
\[\frac{dv}{dt} = p - r_s - gw -et\] 
...
- Typical characteristics of climate in: western Norway, Eastern Norway, Mediteranean, Eastern Europe, California, Bogota
-->
...
<img src="images/RECAP_arctic_norway_cycles.png" height="530" width="auto">
...
<img src="images/albedo_values.png" height="530" width="auto">
...
<img src="images/wcprecipitationworldmap.gif" height="530" width="auto">
...
## Online resources: USA

- https://californiawaterblog.com/2017/03/19/post-drought-groundwater-in-california-like-the-economy-after-a-deep-recession-recovery-will-be-slow/
- USGS summary of the water cycle: https://water.usgs.gov/edu/watercyclesummary.html

## Climate change impact on water resources
http://drought.unl.edu/DroughtBasics/ClimateChange.aspx#Water_Resources
...
https://www.youtube.com/watch?v=bQ8_UZpbtz8&index=179&list=WL
