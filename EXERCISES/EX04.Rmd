...
> - Assume that the mulch bed always infiltrates at the previously calculated infiltration rate: $5*10^{-5}$ m/s
> - How much ponding storage (height of the water paddle in the mulch bed) is needed to handle a 3min 100-year precipitation event (200l/s per Ha)
...
<!-- > - [There](./1_fluid_dynamics.html#exercise-flow-out-of-a-reservoir), we calculated the flow out of a reservoir in very similar conditions. In this case, the reservoirs are the gutters. -->
